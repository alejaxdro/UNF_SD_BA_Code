...
#include <stdio.h>
//#include <termios.h>
#include <math.h>   // gcc -lm needs to be used to compile correctly
#include <errno.h>
#include <time.h>
//#include <string.h>
//#include <unistd.h>
...
void displayprompt()
{
      ...
      printf("**                                                                        **\n");
      printf("**             1. Type r and hit enter to reset turn coefficient          **\n");
      printf("**             1. Type q and hit enter to stop motors                     **\n");
      printf("**                                                                        **\n");
      printf("**             5. Type z and hit enter to end program                     **\n");
      printf("**                                                                        **\n");
      printf("****************************************************************************\n");
      printf("-->");
